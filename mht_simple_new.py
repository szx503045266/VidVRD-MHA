...
from baseline_new.association import *
from baseline_new.trajectory import *
...
def check_trees(treelist, vrelation_list, segment, max_leaves, dataset, max_node_gap=15, min_path_len=1):
    """
